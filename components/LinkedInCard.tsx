...
import { FaLinkedin, FaMapMarkerAlt, FaGraduationCap } from 'react-icons/fa';
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between mb-4">
        <div className="relative">
          ...
          <div
            className="absolute bottom-1 right-1 w-4 h-4 bg-blue-400 rounded-full border-2 border-[#0077b5]"
            title="Student"
            aria-label="Status: Student"
          ></div>
        </div>
      ...
      <div className="relative z-10 mt-2">
        ...
        <p className="text-blue-100 text-sm mb-4">Fullstack Developer | React & Next.js</p>

        <div className="space-y-2 text-sm text-blue-50">
          <div className="flex items-center gap-2">
            <FaGraduationCap className="opacity-70" />
            <span>Computer Science @ GUT</span>
          </div>
          <div className="flex items-center gap-2">
